<template>
    <b-navbar fixed-top centered shadow>
        <template #brand>
            <b-navbar-item>
                <img
                    src="/images/social-logo-transparent.svg"
                    alt="Social"
                >
            </b-navbar-item>
        </template>
        <template #start>
            ...
            <b-navbar-item class="px-5" tag="router-link" :to="{ name: 'HomeFeed' }">
            ...
            <b-navbar-item class="px-5" tag="router-link" :to="{ name: 'Profile' }">
        ...
        <template #end>
            <b-navbar-item tag="div">
                <div v-if="authUser != null">
                    <span style="position:relative; top:7px;">Welcome, {{ authUser.name }}</span>
